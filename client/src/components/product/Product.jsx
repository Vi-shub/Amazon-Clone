...
const Product = () => {
  ...
  useEffect(function() {
    async function fetchSingleProduct() {
      try {
        const res = await axios.get('https://amazon-clone-qr6p.onrender.com/api/product/' + id);
        setProduct(res.data);
        setIsLoading(false);
      } catch (error) {
        console.log(error);
  ...
  async function addToCart(id) {
    try {
      const res = await axios.post('https://amazon-clone-qr6p.onrender.com/api/addtocart/' + id, {
        product
      }, {
        headers: {
  ...
  async function fetchUser() {
    try {
      const res = await axios.get('https://amazon-clone-qr6p.onrender.com/api/getAuthUser', {withCredentials: true});
      if (res) {
    ...
    try {
      ...
      script.onload = async () => {
        try {
          ...
          const res = await axios.post("https://amazon-clone-qr6p.onrender.com/api/create-order", {
          ...
          const { key } = await axios.get("https://amazon-clone-qr6p.onrender.com/api/get-razorpay-key");
          ...
          const options = {
            ...
            handler: async function(response) {
              const result = await axios.post("https://amazon-clone-qr6p.onrender.com/api/pay-order", {
